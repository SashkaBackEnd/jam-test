...
class Translate extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['path'], 'string'],
            [['object_type', 'created_by', 'modified_by'], 'integer'],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\TranslateQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\TranslateQuery(get_called_class());
    }
}
