...
/**
 * This is the model class for table "profile_lang".
 *
 * @property int $id
...
class ProfileLang extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['lang'], 'string', 'max' => 2],
            [['first_name', 'last_name', 'second_name', 'pen_name'], 'string', 'max' => 255],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\ProfileLangQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\ProfileLangQuery(get_called_class());
    }
}
