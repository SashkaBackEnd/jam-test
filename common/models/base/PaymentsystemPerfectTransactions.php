...
/**
 * This is the model class for table "paymentsystem_perfect_transactions".
 *
 * @property int $id
 * @property string|null $payee_account Аккаунт мерчанта в системе PerfectMoney
 ...
 * @property string|null $payment_batch_num Идентификатор платежа в системе PerfectMoney
 * @property string|null $payer_account Аккаунт плательщика в системе PerfectMoney
 * @property string|null $timestampgmt Временная метка даты транзакции в системе PerfectMoney
 ...
 */
class PaymentsystemPerfectTransactions extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'paymentsystem_perfect_transactions';
    }
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\PaymentsystemPerfectTransactionsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\PaymentsystemPerfectTransactionsQuery(get_called_class());
    }
}
