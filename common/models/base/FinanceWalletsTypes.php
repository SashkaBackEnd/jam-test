...
/**
 * This is the model class for table "finance_wallets_types".
 *
 * @property int $id
 * @property string|null $alias Псевдоним типа
 ...
 */
class FinanceWalletsTypes extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\FinanceWalletsTypesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\FinanceWalletsTypesQuery(get_called_class());
    }
}
