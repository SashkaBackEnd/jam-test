...
/**
 * This is the model class for table "news_roles".
 *
 * @property int $id
 ...
 */
class NewsRoles extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['news__id', 'is_view_allowed', 'is_view_denied', 'created_by', 'modified_by'], 'integer'],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\NewsRolesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\NewsRolesQuery(get_called_class());
    }
}
