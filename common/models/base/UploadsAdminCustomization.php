...
/**
 * This is the model class for table "uploads_admin_customization".
 *
 * @property int $id
 ...
 */
class UploadsAdminCustomization extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'uploads_admin_customization';
    }
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\UploadsAdminCustomizationQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\UploadsAdminCustomizationQuery(get_called_class());
    }
}
