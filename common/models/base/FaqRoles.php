...
/**
 * This is the model class for table "faq_roles".
 *
 * @property int $id
 ...
 */
class FaqRoles extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['faq__id', 'is_view_allowed', 'is_view_denied', 'created_by', 'modified_by'], 'integer'],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\FaqRolesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\FaqRolesQuery(get_called_class());
    }
}
