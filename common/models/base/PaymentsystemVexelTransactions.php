...
/**
 * This is the model class for table "paymentsystem_vexel_transactions".
 *
 * @property int $id
 * @property string|null $transaction_id GUID финоперации
 * @property string $ext_id ID платежа в системе Vexel
 ...
 */
class PaymentsystemVexelTransactions extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'paymentsystem_vexel_transactions';
    }
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\base\query\PaymentsystemVexelTransactionsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\base\query\PaymentsystemVexelTransactionsQuery(get_called_class());
    }
}
