...
/**
 * WalletCompany represents the model behind the search form of `admin\modules\wallet\models\Wallet`.
 */
class WalletCompany extends Wallet
{
    /**
     * {@inheritdoc}
     */
