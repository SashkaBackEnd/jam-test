...
namespace admin\modules\wallet\controllers;

use Yii;
use admin\modules\wallet\models\Wallet;
use admin\modules\wallet\models\search\WalletCompany;
...
/**
 * WalletCompanyController implements the CRUD actions for Wallet model.
 */
class WalletCompanyController extends BaseController
{
    /**
     * {@inheritdoc}
     */
